    ...
    $(document).ready( function () { 
        ...
        select.on('chosen:ready', function(event) {
                ...
                if (value.length < 1) {
                    ...
                    api('corsi:volontari:cerca', {query: value, perPagina: 80, ordine: 'selettoreDocente', stato_docente: stato_docente, ruolo: ruolo, data: data, qualifica: qualifica}, function (x) {
